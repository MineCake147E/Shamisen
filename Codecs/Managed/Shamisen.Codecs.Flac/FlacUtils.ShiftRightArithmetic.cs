            ...
            unsafe
            {
                ...
                if (olen < length)
                {
                    for (; i < olen; i += 8 * (uint)Vector128<int>.Count)
                    {
                        ...
                        v0_4s = AdvSimd.ShiftArithmetic(v0_4s, v15_4s);
                        v1_4s = AdvSimd.ShiftArithmetic(v1_4s, v15_4s);
                        v2_4s = AdvSimd.ShiftArithmetic(v2_4s, v15_4s);
                        v3_4s = AdvSimd.ShiftArithmetic(v3_4s, v15_4s);
            ...
            unsafe
            {
                ...
                if (olen < length)
                {
                    for (; i < olen; i += 8 * (uint)Vector256<int>.Count)
                    {
                        ...
                        ymm0 = Avx2.ShiftRightArithmeticVariable(ymm0, ymm15);
                        ymm1 = Avx2.ShiftRightArithmeticVariable(ymm1, ymm15);
                        ymm2 = Avx2.ShiftRightArithmeticVariable(ymm2, ymm15);
                        ymm3 = Avx2.ShiftRightArithmeticVariable(ymm3, ymm15);
            ...
            unsafe
            {
                ...
                if (olen < length)
                {
                    for (; i < olen; i += 8 * (uint)Vector128<int>.Count)
                    {
                        ...
                        xmm0 = Sse2.ShiftRightArithmetic(xmm0, xmm15);
                        xmm1 = Sse2.ShiftRightArithmetic(xmm1, xmm15);
                        xmm2 = Sse2.ShiftRightArithmetic(xmm2, xmm15);
                        xmm3 = Sse2.ShiftRightArithmetic(xmm3, xmm15);
