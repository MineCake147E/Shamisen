...
namespace System.Numerics
{
    ...
    public readonly struct Vector7 : IEquatable<Vector7>
    {
        ...
        public static Vector7 operator -(Vector7 value) => new(-value.front, -value.back);
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector7 operator +(Vector7 left, Vector7 right) => new(left.front + right.front, left.back + right.back);
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector7 operator *(Vector7 left, float right) => new(left.front * right, left.back * right);
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector7 operator *(float left, Vector7 right) => new(right.front * left, right.back * left);
