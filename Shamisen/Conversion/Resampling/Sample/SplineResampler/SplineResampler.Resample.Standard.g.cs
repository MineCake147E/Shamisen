        ...
        private int ResampleCachedWrappedOdd (Span<float> buffer, int channels, Span<float> srcBuffer)
        {
            ...
            if (channels == Vector<float>.Count) //SIMD Optimized Multi-Channel Audio Resampling
            {
                ...
                switch (channels) {
                    ...
                    default:
                        (inputSampleIndex, conversionGradient, rearrangedCoeffsIndex, rearrangedCoeffsDirection) = ResampleCachedWrappedOddGeneric(buffer, srcBuffer, cspan, channels, x, ram, acc, facc, rec, red);
                        return inputSampleIndex;
                }
            }
        }
            ...
            if (channels == Vector<float>.Count) //SIMD Optimized Multi-Channel Audio Resampling
            {
                ...
                switch (channels) {
                    ...
                    case 4 :
                        ...
                        #endregion SIMD Optimized Multi-Channel Audio Resampling
                    default:
                        (inputSampleIndex, conversionGradient, rearrangedCoeffsIndex, rearrangedCoeffsDirection) = ResampleCachedWrappedEvenGeneric(buffer, srcBuffer, cspan, channels, x, ram, acc, facc, rec, red);
                        return inputSampleIndex;
                }
            }
        }
