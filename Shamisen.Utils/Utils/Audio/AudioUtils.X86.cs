        ...
        internal static partial class X86
        {
            ...
            internal static void FastLog2Order5FAvx2Fma(Span<float> destination, ReadOnlySpan<float> source)
            {
                ...
                for (; i < olen; i += 32)
                {
                    ...
                    ymm10 = Fma.MultiplyAdd(ymm6, ymm10, ymm12);
                    ymm11 = Fma.MultiplyAdd(ymm7, ymm11, ymm12);
                    ymm4 = Fma.MultiplyAdd(ymm4, ymm8, ymm0);
                    ymm5 = Fma.MultiplyAdd(ymm5, ymm9, ymm1);
                    ymm6 = Fma.MultiplyAdd(ymm6, ymm10, ymm2);
                    ymm7 = Fma.MultiplyAdd(ymm7, ymm11, ymm3);
                    Unsafe.As<float, Vector256<float>>(ref Unsafe.Add(ref r8, 0 * Vector256<float>.Count)) = ymm4;
                    Unsafe.As<float, Vector256<float>>(ref Unsafe.Add(ref r8, 1 * Vector256<float>.Count)) = ymm5;
                    Unsafe.As<float, Vector256<float>>(ref Unsafe.Add(ref r8, 2 * Vector256<float>.Count)) = ymm6;
                    Unsafe.As<float, Vector256<float>>(ref Unsafe.Add(ref r8, 3 * Vector256<float>.Count)) = ymm7;
                }
                unchecked
                {
