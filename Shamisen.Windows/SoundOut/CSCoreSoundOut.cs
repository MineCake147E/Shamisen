...
using Shamisen.Interop;
using Shamisen.IO;
using ISoundOut = Shamisen.IO.ISoundOut;
using PlaybackState = Shamisen.IO.PlaybackState;

namespace Shamisen.SoundOut
{
    public sealed class CSCoreSoundOut : ISoundOut
    {
        ...
        public void Initialize(IWaveSource source) => Out.Initialize(new ShamisenWaveSourceWrapper(source));
